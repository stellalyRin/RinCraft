...
>
> 3. 该《情况说明》为公共领域作品，这意味着任何人都可以通过 Issues 和 Pull Requests 对该《情况说明》进行任何范围的修改，或直接联系任一笔者代理进行任何范围的修改。修改将最终推送于星澜音，星澜音在审核完毕后即会应用修改。星澜音会保证该《情况说明》中所有事实的准确性，但尽管已经进行了措辞优化和中立化处理，星澜音亦不能保证他人提交的叙述不包含偏袒色彩或明确的倾向性。读者在阅读该《情况说明》时，务必采取批判性的思维和态度；若部分事实与你的记忆和理解不符，亦可联系笔者进行澄清 和/或 修改。
>
> 4. 该《情况说明》并非宣扬仇恨，仅为铭记教训。
>
...
晚 23:36，unDefFtr 请求 星澜音 介入 RinHub 进行劝阻，星澜音 进入 RinHub 后呼吁全体成员冷静，但由于全群气焰过于高亢，发言密集且充满对立，无人能够平静地回应调解，且身为群主的 RinLit 带头对管理层中的 星澜音 发动攻击，招惹了大部分人的跟随，甚至在攻击结束后仍然告诉 星澜音「不要对号入座」，引起管理层愤怒。RinHub 中的 quojsx 连续批判管理层，XieXiLin 在群内大量发表情绪化和离题的内容。部分成员在群内疯狂起哄，几乎无法沟通。一般路过雷批 作为 RinCraft 的中立派尝试稳定全群节奏，引导理性讨论，但没有成功。
...
10 月 7 日晚间，一篇关于 HelloWRC 和 RinLit 的 R-18 文章在 ClassIsland 群聊产生，并迅速传播到了其他群聊。HelloWRC 定位了该文章的作者，并在 ClassIsland 群内将文章作者禁言一天，而后者于 10 月 10 日晚在 ClassIsland 做出道歉声明。为避免事件进一步发酵和扩大，导致波及 Hazelita 群聊，星澜音在 10 月 7 日晚间对 Hazelita 群聊进行全群禁言，临时撤销了所有管理员的职位，并宣布新群规的设立。
